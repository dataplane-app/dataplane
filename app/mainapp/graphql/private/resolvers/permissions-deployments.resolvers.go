...
func (r *mutationResolver) DeploymentPermissionsToUser(ctx context.Context, environmentID string, resourceID string, access []string, userID string) (string, error) {
	...
	perms := []models.Permissions{
		...
		{Subject: "user", SubjectID: currentUser, Resource: "environment_assign_permissions_all_deployments", ResourceID: environmentID, Access: "write", EnvironmentID: environmentID},
		{Subject: "user", SubjectID: currentUser, Resource: "specific_deployment", ResourceID: resourceID, Access: "assign_deployment_permission", EnvironmentID: environmentID},
	}
...
func (r *queryResolver) UserSingleDeploymentPermissions(ctx context.Context, userID string, environmentID string, deploymentID string, subjectType string) (*privategraphql.DeploymentPermissionsOutput, error) {
	...
	perms := []models.Permissions{
		...
		{Subject: "user", SubjectID: currentUser, Resource: "environment_assign_permissions_all_deployments", ResourceID: environmentID, Access: "write", EnvironmentID: environmentID},
		{Subject: "user", SubjectID: currentUser, Resource: "specific_deployment", ResourceID: deploymentID, Access: "assign_deployment_permission", EnvironmentID: environmentID},
	}
