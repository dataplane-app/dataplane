...
func AuthRemoteWorker(remoteWorkerID string, secretToken string) (string, error) {
	...
	// if err != nil {
	// 	log.Println("Remote worker redis already connected - connect error:", err)
	// 	return "", errors.New("Remote worker redis already connected - connect error.")
	// }

	// if val != "" {
	// 	return "", errors.New("A remote worker with this ID already connected.")
	// }
