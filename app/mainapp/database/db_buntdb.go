...
func GoDBConnect() {
	...
	// GoDBWorkerGroup.CreateIndex("environment", "*", buntdb.IndexJSON("EnvID"))

	// GoDBWorker, _ = buntdb.Open(":memory:")

	// GoDBWorker.CreateIndex("environment", "*", buntdb.IndexJSON("EnvID"))
	// GoDBWorker.CreateIndex("workergroup", "*", buntdb.IndexJSON("WorkerGroup"))

	// GoDBQueue, _ = buntdb.Open(":memory:")
	// GoDBQueue.CreateIndex("environment", "*", buntdb.IndexJSON("EnvID"))
