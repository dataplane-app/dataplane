...
import { IOSSwitch } from '../SchedulerDrawer/IOSSwitch.jsx';
import { v4 as uuidv4 } from 'uuid';
import { useGetPipelineTrigger } from '../../../../../graphql/pipelines/getPipelineTrigger.js';
import ApiKey from './ApiKey.jsx';
import ApiTriggerExampleDrawer from '../../configureNodes/APITriggerNodeItem/ApiTriggerExampleDrawer/index.jsx';
...
const APITRiggerDrawer = ({ handleClose }) => {
    ...
    const generatePipelineTrigger = useGeneratePipelineTriggerHook(Environment.id.get(), triggerID, switches, dispatch, getValues);
...
const useGeneratePipelineTriggerHook = (environmentID, triggerID, switches, dispatch, getValues) => {
    // GraphQL hook
    ...
    return async (update) => {
        ...
        console.log("Form values:", formValues, "key active:", apiKeyActive, "public live:",publicLive, "private live:", privateLive)
        ...
        const response = await generatePipelineTrigger({
            ...
            publicLive,
            privateLive,
            dataSizeLimit: Number(formValues["dataSize"]),
            dataTTL: Number(formValues["dataTTL"]),
            ...update,
        });
