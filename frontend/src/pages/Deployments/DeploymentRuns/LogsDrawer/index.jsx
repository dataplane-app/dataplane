            ...
            <Box height="100%" width="100%">
                <ScrollFollow
                    ...
                    render={({ follow, onScroll }) => (
                        <LazyLog selectableLines={true} enableSearch text={filteredGraphqlResp + websocketResp} follow={follow} onScroll={onScroll} />
                    )}
                />
            </Box>
        </>
...
const useGetNodeLogsHook = (environmentID, runID, nodeID, setGraphQlResp, keys) => {
    ...
    // Get logs
    return async () => {
        const response = await getNodeLogs({ environmentID, pipelineID: deploymentId, nodeID, runID });
