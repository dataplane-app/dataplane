    ...
    return(
        <Box className="congratulation" height="100vh" position="relative" sx={{ overflowY: "hidden" }}>
            <Box position="absolute" width="100%" sx={{ top: 0, left: 0, right: 0, border: 1 ,borderColor: "divider" }}>
                <Typography component="h1" variant="h1" color="secondary" fontWeight={700} style={{ padding: "1.5rem 0 1.5rem .75rem" }}>Dataplane</Typography>
            </Box>
            ...
            <Grid container alignItems="center" justifyContent="center" height="100%">
                ...
                <div>
                    <Grid display="flex" alignItems="center" position="relative">
                        <Typography fontSize="3.75rem" textAlign="center" fontWeight="700" color="purple.main">Congratulations</Typography>
                        <Typography position="absolute" fontSize="3.75rem" right="-5rem">🎉</Typography>
                    </Grid>
