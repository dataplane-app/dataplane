...
export const globalEnvironmentState = createState('');
        ...
        (async () => {
            ...
            if (active && getEnvironmentsResponse) {
                ...
                if (getOnePreferenceResponse.value) {
                    ...
                    GlobalEnvironmentID.set(getOnePreferenceResponse.value);
                } else {
                    ...
                    GlobalEnvironmentID.set(getEnvironmentsResponse[0].id);
                }
            }
        })();
