...
/*
go test -p 1 -v -count=1 -run TestDeactivateUser dataplane/Tests/users
...
func TestDeactivateUser(t *testing.T) {
	...
	response, httpResponse := tests.GraphQLRequestPrivate(deactivateUser, accessToken, "{}", graphQLUrlPrivate, t, app)
